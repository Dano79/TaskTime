 ...
 * <p>
 * Provider for the the task time app. This is the only that knows about {@link AppDatabase}
 */
...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "drizzidevs.tasktime.provider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // eg. content://drizzidevs.tasktime.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        // eg. content://drizzidevs.tasktime.provider/Tasks/8
...
//                break;
     ...
     //   Log.d(TAG, "query: rows in returned cursor = " + cursor.getColumnName()); // TODO remove this line
...
//
//            case TASK_DURATIONS:
//                return DurationsContracts.TaskDurations.CONTENT_TYPE;
//
//            case TASK_DURATIONS_ID:
//                return DurationsContracts.TaskDurations.CONTENT_ITEM_TYPE;
